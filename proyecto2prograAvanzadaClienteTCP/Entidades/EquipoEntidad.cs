...
namespace Entidades
{
    public class EquipoEntidad   // clase Equipo con set/get
    {
        ...
        public string NombreCriatura1 { get; set; }
        public string NombreCriatura2 { get; set; }
        public string NombreCriatura3 { get; set; }
